...
def validate_cell_cycle():
    ...
    t_stat, p_val = stats.ttest_ind(rb_wt['E2F'], rb_loss['E2F'], equal_var=False)
    ...
    if rb_loss['E2F'].mean() < rb_wt['E2F'].mean():
        print("\nVERDICT: EMPIRICAL PARITY CONFIRMED. The hyper-dependency on E2F in Rb-loss contexts validates the STP-Diff's identification of the E2F bottleneck.")
    else:
