"""
STP-Diff: Semi-Tensor Product Differentiable Boolean Network Research Suite
...
class PGDAttacker:
    """
    Projected Gradient Descent (PGD) Attacker for STP-Diff. Implements High-Temperature Softmax to force gradient flow through rigid logic.
    """
